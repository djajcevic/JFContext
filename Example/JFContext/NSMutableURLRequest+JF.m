...
+ (NSMutableURLRequest *)postRequestWithUrl:(NSString *)url headerAtt:(NSDictionary *)headerAtt
                                 andBodyAtt:(NSDictionary *)bodyAttr
{
...
+ (NSMutableURLRequest *)get:(NSString *)urlFormat withPathDictionaryValues:(NSDictionary *)values
{
    NSString *resultUrl = @"";

    if (urlFormat) {
        resultUrl = [urlFormat stringByReplacingPlaceholders:values];
    }
